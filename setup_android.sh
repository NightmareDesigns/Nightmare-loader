...
echo
echo -e "  ${YELLOW}─── Windows Repair & PC Recovery (boot these to fix your PC) ───${RESET}"
echo
echo "    rescuezilla   Rescuezilla – disk imaging, file recovery,    ~780 MB"
echo "                  Windows drive repair (easy graphical tool)"
echo "    systemrescue  SystemRescue – Linux live with chntpw,        ~800 MB"
echo "                  ntfs-3g, password reset, registry repair"
echo "    gparted       GParted Live – resize / fix partitions        ~600 MB"
echo "    clonezilla    Clonezilla – backup & restore your disk       ~450 MB"
echo "    memtest86plus Memtest86+ – test your RAM for errors          ~15 MB"
echo "    shredos       ShredOS – securely wipe a drive (nwipe)        ~30 MB"
echo
echo "  Quick Windows 11 repair example:"
echo "    nightmare-loader download rescuezilla --out ~/storage/downloads"
echo "    # then on PC: nightmare-loader prepare /dev/sdX"
echo "    #             nightmare-loader add /dev/sdX rescuezilla-*.iso"
echo "    # Reboot PC from USB → choose Rescuezilla → repair Windows drive"
echo
echo -e "  ${YELLOW}─── Linux Desktop Distros ───────────────────────────────────${RESET}"
echo
...
echo
echo -e "  ${YELLOW}─── Security & Privacy ──────────────────────────────────────${RESET}"
echo
...
echo
echo "  NOTE: ISOs not available for direct download (get manually):"
echo "    hirens     – Hiren's BootCD PE  https://www.hirensbootcd.org"
echo "    chromeos   – ChromeOS Flex      https://chromeenterprise.google/os/chromeosflex"
echo "    windows    – Windows 11 ISO     https://www.microsoft.com/en-us/software-download/windows11"
echo
echo -e "${GREEN}============================================================${RESET}"
